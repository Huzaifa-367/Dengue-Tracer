...
class Drabable_Navigation_Bar_Screen extends StatefulWidget {
  const Drabable_Navigation_Bar_Screen({super.key});

  @override
  Drabable_Navigation_Bar_ScreenState createState() =>
      Drabable_Navigation_Bar_ScreenState();
}

class Drabable_Navigation_Bar_ScreenState
    extends State<Drabable_Navigation_Bar_Screen> {
